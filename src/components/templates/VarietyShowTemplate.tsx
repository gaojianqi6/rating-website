...
interface VarietyShowTemplateProps {
  item: Item;
...
const VarietyShowTemplate = ({ item, ratingsData, userRating, onRateClick }: VarietyShowTemplateProps) => {
...
export default VarietyShowTemplate; 